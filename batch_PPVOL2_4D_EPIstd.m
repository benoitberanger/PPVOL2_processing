...
%ou
suj = get_subdir_regex(chemin,'Pilote'); %to get all subdir that start with 2
%to see the content
char(suj)
...
par.dfonc_reg_oposit_phase = 'refPA$'; % [AZER]
...
fons_localizer = get_subdir_regex_files(onsetdir,'^loca',1);
...
j_contrast_localizer = job_first_level12_contrast(fspm_localizer,contrast_localizer,par)
